        ...
        <div className={styles.cardWrapper}>
          ...
          <div className={styles.card}>
            <div
              ...
              style={{ justifyContent: 'space-around', padding: '0 20px' }}
            >
              <div className={styles.item}>
                <img
                  src='/icons/icon_html.svg'
                  alt='html'
                />
                <h2>HTML</h2>
              </div>
            ...
            <div
              className={styles.row}
              style={{ justifyContent: 'space-even', padding: '0 20px' }}
            >
              <div className={styles.item}>
                <img
        ...
        <div className={styles.cardWrapper}>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.row}>
              <div className={styles.item}>
                <img
                  src='/icons/icon_illustrator.svg'
                  alt='illustrator'
                />
